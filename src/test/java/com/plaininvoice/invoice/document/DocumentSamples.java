...
final class DocumentSamples {
  ...
  static Quantity quantity(String value) {
    return new Quantity(new BigDecimal(value));
  }

  static Percentage percent(String value) {
