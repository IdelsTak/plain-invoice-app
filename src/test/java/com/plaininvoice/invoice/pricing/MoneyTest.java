...
final class MoneyTest {
  ...
  @Test
  void subtractsMoneyDeterministically() {
    var result = new Money(new BigDecimal("10.00"), new CurrencyCode("USD"))
      .subtract(new Money(new BigDecimal("2.50"), new CurrencyCode("USD")));
    assertThat(result.amount(), comparesEqualTo(new BigDecimal("7.50")));
  }
}
